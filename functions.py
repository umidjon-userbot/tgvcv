...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text((190, 550), f"Nomi: {title}", (255, 255, 255), font=font)
    draw.text(
        (190, 590), f"Davomiyligi: {duration}", (255, 255, 255), font=font
    )
    draw.text((190, 630), f"Ko'rishlar soni: {views}", (255, 255, 255), font=font)
    draw.text((190, 670),
